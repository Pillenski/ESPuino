...
const char modeAllTrackRecursive[] = "Modus: Spiele alle Tracks (sortiert) des Ordners '%s' und seiner Unterordner";
const char modeAllTrackRecursiveRandom[] = "Modus: Spiele alle Tracks (zufällig sortiert) des Ordners '%s' und seiner Unterordner";
