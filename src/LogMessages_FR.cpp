...
const char modeAllTrackRecursive[] = "Mode : toutes les pistes (par ordre) du répertoire '%s' et tous ses sous-répertoires";
const char modeAllTrackRecursiveRandom[] = "Mode : toutes les pistes (par ordre aléatoire) du répertoire '%s' et tous ses sous-répertoires";
