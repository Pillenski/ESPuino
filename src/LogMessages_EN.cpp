...
const char modeAllTrackRecursive[] = "Mode: all tracks (in order) of directory '%s' and all of it's subdirectories";
const char modeAllTrackRecursiveRandom[] = "Mode: all tracks (in random order) of directory '%s' and all of it's subdirectories";
