...
#define __ESPUINO_SETTINGS_LOLIN_D32_PRO_H__
    ...
    */
    ...
    #define PREVIOUS_BUTTON                 103         // Prev-Button: connected to port-expander
    #define PAUSEPLAY_BUTTON                104         // Pplay-Button: connected to port-expander
    ...
    #define BUTTON_5                        107       // Button 5: connected to port-expander
    ...
    // Infos: https://forum.espuino.de/t/einsatz-des-port-expanders-pca9555/306
        ...
        #define PE_INTERRUPT_PIN            32          // GPIO that is used to receive interrupts from port-expander + to wake up ESP32
    #endif
    ...
    #define WAKEUP_BUTTON                   32          // Defines the button that is used to wake up ESPuino from deepsleep; set to 99 to disable

    // Power-control
    #define POWER                           33         // GPIO used to drive transistor-circuit, that switches off peripheral devices while ESP32-deepsleep
    #ifdef POWER
