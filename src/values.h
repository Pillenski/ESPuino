...
#define ALL_TRACKS_OF_ALL_SUBDIRS_SORTED                          15 // Play all tracks of all subdirectories (sorted by path)
#define ALL_TRACKS_OF_ALL_SUBDIRS_RANDOM                          16 // Play all tracks of all subdirectories in randomized order
